...
function NavBar({ onAvatarClick, onInviteClick }) {
    ...
    return (_jsx("nav", { className: "nb-root", children: _jsxs("div", { className: "nb-inner", children: [_jsxs(NavLink, { to: "/", className: "nb-brand", children: [_jsx("div", { className: "nb-brand-dot" }), _jsx("span", { className: "nb-brand-name", children: "ShPoint" })] }), _jsxs("div", { className: "nb-nav", children: [_jsx(NavLink, { to: "/", className: ({ isActive }) => `nb-link ${isActive ? "is-active" : ""}`, children: "Home" }), _jsx(NavLink, { to: "/library", className: ({ isActive }) => `nb-link ${isActive ? "is-active" : ""}`, children: "Library" }), me && (_jsxs(_Fragment, { children: [me.status !== 'SUSPENDED' && (_jsxs(_Fragment, { children: [_jsx(NavLink, { to: "/my-collection", className: ({ isActive }) => `nb-link ${isActive ? "is-active" : ""}`, children: "My Collection" }), _jsx(NavLink, { to: "/strike-teams", className: ({ isActive }) => `nb-link ${isActive ? "is-active" : ""}`, children: "Strike Teams" })] })), (me.role === "ADMIN" || me.role === "EDITOR") && me.status !== 'SUSPENDED' && (_jsx(NavLink, { to: "/content-management", className: ({ isActive }) => `nb-link ${isActive ? "is-active" : ""}`, children: "Content" })), me.role === "ADMIN" && me.status !== 'SUSPENDED' && (_jsx(NavLink, { to: "/admin", className: ({ isActive }) => `nb-link ${isActive ? "is-active" : ""}`, children: "Admin" }))] }))] }), _jsxs("div", { className: "nb-actions", children: [!loading && !me && (_jsx("button", { className: "nb-btn", onClick: gotoLogin, children: "Sign in" })), loading ? (_jsx("span", { className: "nb-guest", children: "..." })) : me ? (_jsxs(_Fragment, { children: [_jsxs("div", { style: {
                                        display: "flex",
                                        alignItems: "center",
                                        gap: "8px",
                                        cursor: "pointer",
