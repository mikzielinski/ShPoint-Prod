...
const iconChar = (t) => ICON[t] ?? (t.match(/^\[(\d+)\]$/)?.[1] ?? t);
...
function renderGlyphLine(tokens, variant = 'default') {
    ...
    return (_jsx("span", { style: { display: "inline-flex", gap: 6, flexWrap: "wrap", alignItems: "center" }, children: tokens.map((t, i) => {
            ...
            if (t.includes("->")) {
                ...
                return (_jsxs("span", { style: { display: "inline-flex", gap: 4, alignItems: "center" }, children: [renderGlyphToken(from.trim(), `${i}-from`, variant), _jsx("span", { style: { color: C.treeNodeFg, fontSize: 12, fontWeight: 700 }, children: "\u2192" }), renderGlyphToken(to.trim(), `${i}-to`, variant)] }, i));
            }
            return (_jsxs("span", { style: { display: "inline-flex", alignItems: "center" }, children: [renderGlyphToken(t, i, variant), i < tokens.length - 1 && (_jsx("span", { style: {
                            color: '#ffffff',
                            fontSize: 16,
                            fontWeight: 700,
                            marginLeft: 6,
...
function CombatTree({ tree, edges, }) {
    ...
    return (_jsxs("div", { style: {
            ...
            padding: 14,
            background: C.cardBg,
        }, children: [_jsx("div", { style: { fontWeight: 700, marginBottom: 10 }, children: "Combat tree" }), _jsxs("div", { ref: containerRef, style: {
                    position: "relative",
                    display: "grid",
                    ...
                    padding: 4,
                        ...
                        return (_jsx("div", { ref: (el) => {
                            ...
                            }, children: tokens.map((t, i) => renderGlyphToken(t, i)) }, `node-${rIdx}-${cIdx}`));
                    }))] })] }));
}
/** ====== Tabelki Expertise ====== */
