...
const MiniatureMap = ({ mission, activeObjectives, size }) => {
    ...
    return (_jsxs("div", { style: {
            ...
            borderRadius: '4px',
            overflow: 'hidden'
        }, children: [_jsxs("svg", { width: size, height: size, style: { position: 'absolute', top: 0, left: 0 }, children: [Array.from({ length: Math.floor(mapRange / 4) + 1 }, (_, i) => {
                        const x = centerX + ((i - mapRange / 8) * 4 * scaleToPixels);
                        return (_jsx("line", { x1: x, y1: 0, x2: x, y2: size, stroke: "#333", strokeWidth: "0.5" }, `v-${i}`));
                    }), Array.from({ length: Math.floor(mapRange / 4) + 1 }, (_, i) => {
                        const y = centerY - ((i - mapRange / 8) * 4 * scaleToPixels);
                        return (_jsx("line", { x1: 0, y1: y, x2: size, y2: y, stroke: "#333", strokeWidth: "0.5" }, `h-${i}`));
                    })] }), _jsx("svg", { width: size, height: size, style: { position: 'absolute', top: 0, left: 0, zIndex: 10 }, children: mission.objectives.map((objective) => {
                    ...
                    return (_jsx("circle", { cx: x, cy: y, r: radius, fill: color, stroke: "#fff", strokeWidth: "0.5", style: {
                                            ...
                                            fontStyle: 'italic'
                                                ...
                                                fontSize: '16px'
                                                    ...
                                                    transition: 'all 0.3s ease'
                                                            ...
                                                            fontWeight: 'bold',
                                                            marginBottom: '5px'
                                                        }, children: card.name }), card.options && (_jsx("div", { style: { marginTop: '8px', display: 'flex', gap: '8px' }, children: card.options.map((option, optionIndex) => {
                                                            ...
                                                            return (_jsxs("div", { onClick: (e) => {
                                                                ...
                                                                }, children: [_jsx(MiniatureMap, { mission: mission, activeObjectives: option.active, size: 80 }), _jsx("div", { style: {
                                                                            textAlign: 'center',
                                                                            fontSize: '10px',
