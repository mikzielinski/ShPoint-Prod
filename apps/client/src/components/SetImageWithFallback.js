...
const SetImageWithFallback = ({ set, size = 300 }) => {
    ...
    return (_jsx("div", { style: {
            ...
            width: size,
            height: 'auto'
        }, children: imageSrc ? (_jsx("img", { src: imageSrc, alt: set.name, style: {
                width: '100%',
                height: '100%',
                objectFit: 'cover'
            }, onError: handleImageError })) : (_jsxs("div", { style: {
                display: 'flex',
                ...
                textAlign: 'center',
                padding: '20px'
            }, children: [_jsx("svg", { width: "48", height: "48", viewBox: "0 0 24 24", fill: "currentColor", style: { marginBottom: '8px' }, children: _jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" }) }), _jsx("div", { style: { fontSize: '12px', fontWeight: '500' }, children: set.code }), _jsx("div", { style: { fontSize: '10px', marginTop: '4px' }, children: "No image" })] })) }));
};
