    ...
    return (_jsxs("div", { style: { padding: '20px' }, children: [_jsx("h1", { style: {
                    ...
                    gap: '20px'
                        ...
                        e.currentTarget.style.transform = 'translateY(0)';
                                ...
                                color: '#9ca3af',
                                fontSize: '12px'
                            }, children: "Sign in to add sets to your collection" }))] }, set.id))) }), showSetModal && selectedSet && (_jsx(SetModal, { set: selectedSet, onClose: handleCloseSetModal })), showCharacterModal && selectedCharacter && (_jsx(CharacterModal, { open: showCharacterModal, onClose: handleCloseCharacterModal, id: selectedCharacter.id, character: selectedCharacter }))] }));
};
