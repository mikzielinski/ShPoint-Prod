...
const HomePage = () => {
    ...
    const handlePreviewNews = (newsItem) => {
            ...
            padding: '20px'
                    ...
                    margin: '0 auto'
                            ...
                            marginBottom: '40px'
                                    ...
                                    backgroundClip: 'text'
                                }, children: "ShPoint News" }), _jsx("p", { style: {
                                    fontSize: '20px',
                                    color: '#9ca3af',
                                    maxWidth: '600px',
                                    margin: '0 auto',
                                    lineHeight: '1.6'
                                }, children: "Latest updates and features for Star Wars: Shatterpoint collection manager" }), me && (_jsxs("div", { style: {
                                    marginTop: '20px',
                                    fontSize: '16px',
                                    color: '#6b7280'
                            ...
                            gap: '20px',
                            marginBottom: '40px'
                        }, children: statsData.map((stat, index) => (_jsxs("div", { style: {
                                ...
                                textAlign: 'center'
                                        ...
                                        color: '#9ca3af',
                                        fontWeight: '500'
                                    }, children: stat.label })] }, index))) }), me && (_jsxs("div", { style: {
                            marginBottom: '40px'
                            ...
                            border: '1px solid #374151'
                                    ...
                                    marginBottom: '24px'
                                            ...
                                            color: '#f9fafb',
                                            margin: '0'
                                        }, children: "Latest News & Updates" }), (me?.role === 'ADMIN' || me?.role === 'EDITOR') && (_jsx("button", { onClick: handleNewNews, style: {
                                            padding: '8px 16px',
                                            borderRadius: '6px',
                                            border: 'none',
                                            background: '#10b981',
                                            ...
                                            fontWeight: '600',
                                            cursor: 'pointer'
                                        }, children: "+ Add News" }))] }), _jsx("div", { style: {
                                    display: 'flex',
                                    flexDirection: 'column',
                                    gap: '24px'
                                }, children: newsItems.map((update, index) => (_jsxs("div", { style: {
                                        background: '#0f172a',
                                        borderRadius: '12px',
                                        padding: '24px',
                                        border: '1px solid #374151',
                                        borderLeft: `4px solid ${getStatusColor(update.status)}`
                                                ...
                                                marginBottom: '12px'
                                                        ...
                                                        gap: '8px'
                                                                ...
                                                                color: getStatusColor(update.status)
                                                            }, children: [getStatusIcon(update.status), update.status?.toUpperCase() || 'UNKNOWN'] }), (me?.role === 'ADMIN' || me?.role === 'EDITOR') && (_jsxs("div", { style: { position: 'relative' }, children: [_jsx("button", { onClick: (e) => {
                                                                        e.stopPropagation();
                                                                        ...
                                                                        boxShadow: '0 4px 12px rgba(0, 0, 0, 0.3)'
                                                                            ...
                                                                            }, children: "\uD83D\uDC41\uFE0F Preview" }), _jsx("button", { onClick: (e) => {
                                                                                e.stopPropagation();
                                                                                ...
                                                                                e.currentTarget.style.background = 'transparent';
                                                                            }, children: "\u270F\uFE0F Edit" }), me?.role === 'ADMIN' && (_jsx("button", { onClick: (e) => {
                                                                                e.stopPropagation();
                                                                                ...
                                                                                e.currentTarget.style.background = 'transparent';
                                                                            }, children: "\uD83D\uDDD1\uFE0F Delete" }))] })] }))] })] }), _jsx("p", { style: {
                                                fontSize: '14px',
                                                color: '#9ca3af',
                                                lineHeight: '1.5',
                                                marginBottom: '16px'
                            ...
                            color: '#6b7280',
                            fontSize: '14px'
                        }, children: [_jsx("p", { children: "ShPoint News - Star Wars: Shatterpoint Updates" }), _jsx("p", { style: { marginTop: '8px', fontSize: '12px' }, children: "Built with \u2764\uFE0F for the Shatterpoint community" })] })] }), showNewsEditor && (_jsx(Modal, { open: showNewsEditor, onClose: handleCancelNewsEditor, maxWidth: 900, children: _jsx(NewsEditor, { newsItem: editingNews, onSave: handleSaveNews, onCancel: handleCancelNewsEditor, onDelete: editingNews ? handleDeleteNews : undefined }) })), showNewsPreview && previewNews && (_jsx(Modal, { open: showNewsPreview, onClose: handleCloseNewsPreview, maxWidth: 900, children: _jsx(NewsPreview, { newsItem: previewNews }) }))] }));
};
