...
export default function MyCollectionPage() {
    ...
    return (_jsxs("div", { style: { maxWidth: 1200, margin: "0 auto", padding: "0 16px" }, children: [_jsx("h1", { style: { margin: "18px 0" }, children: "My Collection" }), _jsx("div", { style: {
                    display: 'flex',
                    gap: '4px',
                    marginBottom: '20px',
                    ...
                    padding: 16,
                        ...
                        flexDirection: "column"
                            ...
                            { id: 'builder', label: 'Builder', count: null }
                                ...
                                gap: '20px'
                            }, children: getPublishedStrikeTeams().map((team) => (_jsx(StrikeTeamCard, { team: team, allCharacters: allCharacters, characterCollections: characterCollections }, team.id))) })) })), strikeTeamSubTab === 'private' && (_jsx("div", { children: getPrivateStrikeTeams().length === 0 ? (_jsxs("div", { style: {
                                padding: '40px',
                                textAlign: 'center',
                                background: '#1f2937',
                                borderRadius: '8px',
                                ...
                                gridTemplateColumns: 'repeat(auto-fill, minmax(350px, 1fr))',
                                gap: '20px'
                            }, children: getPrivateStrikeTeams().map((team) => (_jsx(StrikeTeamCard, { team: team, allCharacters: allCharacters, characterCollections: characterCollections }, team.id))) })) })), strikeTeamSubTab === 'builder' && (_jsxs("div", { children: [_jsxs("div", { style: {
                                    padding: '40px',
                                    textAlign: 'center',
                        ...
                        minHeight: '600px'
                            ...
                            } })] }) })), selectedMission && (_jsx(MissionModal, { mission: selectedMission, onClose: () => setSelectedMission(null) }))] }));
}
const StrikeTeamCard = ({ team, showTeamType = false, teamType, allCharacters, characterCollections }) => {
    ...
    return (_jsxs("div", { style: {
            ...
            e.currentTarget.style.boxShadow = '0 4px 15px rgba(0,0,0,0.2)';
                            ...
                            flexWrap: 'wrap'
                                    ...
                                    alignItems: 'center',
                                    gap: '4px'
                                }, children: teamType === 'Real' ? '🎯 Real Team' : '💭 Dream Team' }))] })] }), _jsxs("div", { style: {
                    display: 'flex',
                    gap: '16px',
                    marginBottom: '20px',
                    padding: '12px',
                    ...
                    fontSize: '14px'
                            ...
                            gap: '8px'
                        }, children: team.characters.slice(0, 6).map((teamChar) => {
