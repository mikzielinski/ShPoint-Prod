...
export function iconFromCode(code) {
...
export function Icon({ name, size = 22, className = "", title, style = {}, }) {
    return className = {} `sp-icon ${className}`;
}
style = {};
{
    fontSize: size,
    ...
    "inline-block",
        fontFamily;
    '"ShatterpointIcons", system-ui, -apple-system, Segoe UI, Roboto, sans-serif',
    ;
    style,
    ;
}
